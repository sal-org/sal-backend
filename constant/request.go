...
var (
	...
	ContentInWebAddRequiredFields                   = []string{"title", "photo", "content", "type", "duration", "category_id", "content_mode", "resource_id"}
	...
	WebinarOrderCreateRequiredFields                = []string{"client_id", "webinar_id"}
	...
	TherapistOrderCreateForCorporateRequiredFields  = []string{"client_id", "therapist_id", "date", "time"}
	...
	ClientAppFeedbackRequiredFields                 = []string{"user_id", "type", "details"}
