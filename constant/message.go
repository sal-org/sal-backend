...
const (
	...
	ClientWebApplicationAppointmentConfirmationTextMessage = "Hey ###first_name###, your appointment is confirmed with Clovemind therapist. Please use a stable Wi-Fi. Date: ###date###, Time ###time###. - Team Salubrium"
	...
	ClientInPersonEventCancellationTextMessage             = "Hey there, your In-person Clove Café on ###topic### for ###date### at ###time### has been cancelled successfully - Team Salubrium "
	...
	ClientInPersonEventRequestTextMessage                            = "Hey there, your request for an In-person Clove Café session on ###topic### at ###location### has been received. We'll notify as soon as the slot is available. - Team Salubrium"
	ClientAppointmentRequestSMSToClientTextMessage                   = "Hi ###clientName###, your request for a virtual appointment with ###counsellorName### has been duly noted. Clove team will revert soon. Team Salubrium"
	ClientInPersonRequestSMSToClientTextMessage                      = "Hey ###clientName###, thank you for requesting an in-person Clove therapist appointment with ###counsellorName###. It has been duly noted. We will soon revert on this - Team Salubrium"
