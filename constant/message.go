...
const (
	...
	ClientAppointmentReminderTextMessage = "Hey ###user_name###, just a quick appointment reminder for your upcoming session with ###userName### in the Clove mobile app. It is starting soon at ###time###. - Team Salubrium."
