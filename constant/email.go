...
const (
	...
	ClientAppointmentBookCounsellorEmailBody            = "You have a new counselling session booked by ###client_name### for ###date_time###. Check 'Booking section' for details."
	...
	ClientAppointmentBookClientEmailBody                = "Your appointment for one to one chat with ###therpist_name### is confirmed  for ###date_time###."
