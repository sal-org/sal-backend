...
const (
	...
	ClientSignupClientTpFamilyMemeberToLoginStepCorEmailBody = "You have been added by ###employee_name### as a family member to avail our corporate employee wellbeing services in partnership with ###company_name###."
	ClientAppointmentBookCounsellorEmailBody                 = "You have a new counselling session booked by ###client_name### for ###date### at ###time###. Check 'Booking section' for details. Please note that the call may be recorded for quality and training purposes in accordance with the privacy policy."
	...
	ClientInPersonEventConfrimationEmailBody                 = "Thank you for registering for the upcoming in-person Clove Café. The topic is ###topic### and will be conducted at ###location### on ###date### at ###time###. Please reach the designated location at least 10 minutes before the scheduled start time."
	ClientInPersonEventCancellationEmailBody                 = "We have received your request to cancel the upcoming in-person Clove Café on ###topic###. It would have been great to see you there, but we understand your situation. This will allow other people to book the slot in your place, as they are limited."
	...
	TherapistAttachDocumentsFollowDateFooterClientBody       = "Your therapist has also recommended the next follow up session to be ###followupdate###. Book your slot accordingly to continue your wellbeing journey."
	TherapistAttachAssessmentWithClientBody                  = "Your therapist has also suggested taking ###assessment_name### on the Clovemind mobile application."
)
