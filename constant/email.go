...
const (
	...
	ClientAppointmentRescheduleClientEmailBody          = "Your request for a session reschedule has been confirmed for ###date### at ###time### with ###therpists_name###, Click 'My Sessions' for more details"
